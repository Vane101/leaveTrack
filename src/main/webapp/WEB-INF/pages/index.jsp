                            ...
                            <form action="${loginUrl}" method="post">
                                <table>
                                            <tr>
                                                ...
                                                <td><input type="text"name="username" maxlength="25" size="16" required="required" value=""/></td>
                                            </tr>
                                            <tr>
                                                <td><%--@declare id="password"--%><label for="password">password:</label></td>
                                                <td><input type="password" name="password" required="required" maxlength="40" size="16" value="" /></td>
                                            </tr>
                                            <tr>
                                                <td></td>
                                                <td>
